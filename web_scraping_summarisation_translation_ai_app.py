...
def get_response(source_language: str, summary_language: str, request: str,
    ...
    try:
        ...
        if source_language and summary_language and any([url, file, text]):
            ...
            summarise in {summary language} the following text in 
            {source language}:
            ...
            if text_tokens_length > 0 and text_tokens_length < 11000:
                ...
                for i, sentence in enumerate(sentences):
                    ...
                    if (current_text_tokens_length > 0 and
                        current_input_tokens_length < max_tokens_length):
...
app = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(
            choices=languages_list, label='Summary language', type='value'),
